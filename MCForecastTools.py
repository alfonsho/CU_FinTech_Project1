...
class MCSimulation:
    ...
    def plot_simulation(self):
        ...
        plot_mean = self.simulated_return.plot(legend=None,title=plot_title, figsize=(20, 20), alpha=0.1)
        plot_mean = self.simulated_return.mean(axis=1).plot(legend=None,title=plot_title, figsize=(20, 20), linewidth=5)
